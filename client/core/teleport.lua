...
function Feather.Teleport:IsBusy()
    return teleporting
end

function Feather.Teleport:FindSurface(x, y, fallbackZ, options)
...
function Feather.Teleport:ToCoords(coords, options)
    options = type(options) == 'table' and options or {}
...
function Feather.Teleport:ToWaypoint(options)
